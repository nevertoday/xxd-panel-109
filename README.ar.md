...
# XXD Panel 109｜سجل التفكيك الهندسي الناعم

فكّك الصورة إلى ذاكرة هندسية تُعرَف من النظرة الأولى بكتل لونية كاملة
...
النماذج التالية أنشأها Panel 109 بشكل مستقل من مراجع أصلية مختلفة، وقد أزيلت منها بيانات الذكاء الاصطناعي الوصفية.
...
تحمل الصور هوية ومشاعر قوية، لكنها قد تحتاج إلى إعادة تنظيم أكثر قصداً. يحافظ **Panel 109** على واقع الصورة ويترجم النصف الآخر بلغته البصرية المستقلة، لملصقات الفن والنشر المستقل والمعارض والمحتوى الاجتماعي والتصميم الخالص.
...
**الكلمات المفتاحية:** تفكيك هندسي · وحدات كتل لونية كبيرة · ألوان ناعمة راقية · حبيبات ورقية · كولاج حداثي · فراغ تحريري

## أوضاع الإخراج الأربعة

- `top-bottom`: تكوين رأسي أصلي 3:4؛ الصورة الواقعية أعلى وتصميم Panel 109 أسفل، بنسبة 50% لكل منهما بدقة.
...
يناسب الصور الواضحة الهوية كثيرة المعلومات، ويعيد بناءها بعدد أقل من المساحات الهندسية الكبيرة والكاملة: مستطيلات وكتل مستديرة وحذف ومثلثات وأشكال غير منتظمة منضبطة، من دون تفتيت الموضوع إلى شظايا صغيرة.

- مناسب لملصقات وأغلفة ورسوم معارض حداثية تحافظ على الهوية.
- ينظم 2–4 ألوان من الصورة في نظام ناعم وراقٍ مع حبيبات ورقية وفراغ تحريري.
- يتجنب النقل الواقعي والتفتيت المفرط والكولاج الطفولي و3D والقوالب.

## فحص سريع ومنطق التحويل

`قراءة الهوية والبنية → إبقاء الخطوط الحاسمة و2–4 ألوان → حذف الخلفية الدقيقة → إعادة البناء بوحدات هندسية كاملة → موازنة الشكل الموجب والسالب وحبيبات الورق والفراغ`
...
المواصفات الكاملة: [SKILL.md](SKILL.md) · [مهايئ التشغيل](references/xxd-panel-109-prompt.en.md) · [الموجّه الأصلي](references/original-prompt/zh-CN.md)
...
تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–109 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
